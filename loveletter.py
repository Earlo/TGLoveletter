...
class LoveLetter:
	...
	def play(self, card, target_player = 0, card_guess = 0):
		...
		if card == 8: #Princess
			...
			public_message += "Player " + self.current_name() + " discarded the Princess and dieded! RIP\n"
	
		if card == 7: #Countess
			public_message += "Player " + self.current_name() + " discarded the Countess, but y tho?\n"
		...
		if card == 5: #Prince
			...
			public_message += "Player " + self.current_name() + " discarded their prince.\n"

		if card == 4: #Handmaiden
			player[turnNumber].handMaiden = True
			public_message += "Player " + self.current_name() + " discarded their whore Handmaiden.\n"
